...
void ProSolve() {
	for (i64 i0=1; i0<10; i0++) {
		for (i64 i1=1; i1<10; i1++) {
			if (i1 == i0) continue;
			for (i64 i2=1; i2<10; i2++) {
				if (i2 == i0 || i2 == i1) continue;
				for (i64 i3=1; i3<10; i3++) {
					if (i3 == i0 || i3 == i1 || i3 == i2) continue;
					if (i0 + i3 != d1) continue;
					if (i1 + i2 != d2) continue;
					if (i0 + i1 != r1) continue;
					if (i2 + i3 != r2) continue;
					if (i0 + i2 != c1) continue;
					if (i1 + i3 != c2) continue;
					cout << i0 << " " << i1 << endl << i2 << " " << i3; return;
				}
			}
		}
	}
