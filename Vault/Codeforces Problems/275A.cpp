...
void Input() {
	cin >> x; cnt[0][0] += x; cnt[0][1] += x; cnt[1][0] += x;
	cin >> x; cnt[0][1] += x; cnt[0][0] += x; cnt[0][2] += x; cnt[1][1] += x;
	cin >> x; cnt[0][2] += x; cnt[0][1] += x; cnt[1][2] += x;
	cin >> x; cnt[1][0] += x; cnt[1][1] += x; cnt[0][0] += x; cnt[2][0] += x;
	cin >> x; cnt[1][1] += x; cnt[0][1] += x; cnt[2][1] += x; cnt[1][0] += x; cnt[1][2] += x;
	cin >> x; cnt[1][2] += x; cnt[1][1] += x; cnt[0][2] += x; cnt[2][2] += x;
	cin >> x; cnt[2][0] += x; cnt[2][1] += x; cnt[1][0] += x;
	cin >> x; cnt[2][1] += x; cnt[2][0] += x; cnt[2][2] += x; cnt[1][1] += x;
	cin >> x; cnt[2][2] += x; cnt[2][1] += x; cnt[1][2] += x;
}

void Solve() {
	for (i64 i=0; i<3; i++) {
		for (i64 j=0; j<3; j++) cout << cnt[i][j] % 2;
		cout << endl;
	}
}
/*****************************************/
