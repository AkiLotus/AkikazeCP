...
/************** [GLOBAL VARIABLES] **************/
string F, M, S; map<string, i64> Map;
/************************************************/
...
void Solve() {
	if (Map.size() != 2) {cout << "?"; return;}
	if (Map.find("rock") != Map.end() && Map.find("paper") != Map.end()) {
		if (Map["paper"] > 1) {cout << "?"; return;}
		if (F == "paper") cout << "F"; else if (M == "paper") cout << "M"; else cout << "S";
	}
	if (Map.find("scissors") != Map.end() && Map.find("rock") != Map.end()) {
		if (Map["rock"] > 1) {cout << "?"; return;}
		if (F == "rock") cout << "F"; else if (M == "rock") cout << "M"; else cout << "S";
	}
	if (Map.find("paper") != Map.end() && Map.find("scissors") != Map.end()) {
		if (Map["scissors"] > 1) {cout << "?"; return;}
		if (F == "scissors") cout << "F"; else if (M == "scissors") cout << "M"; else cout << "S";
	}
}
/*****************************************/
