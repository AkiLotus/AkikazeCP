...
/************** [GLOBAL VARIABLES] **************/
i64 n; vi a; i64 GCD[700][700];
bitset<700*700*700> dp; bool dpL[700][700], dpR[700][700];
/************************************************/
...
void Solve() {
	...
	for (i64 i=0; i<n; i++) {
		if (dp[i*n*n+0*n+n-1]) {cout << "Yes"; return;}
	}
	cout << "No";
}
/*****************************************/
