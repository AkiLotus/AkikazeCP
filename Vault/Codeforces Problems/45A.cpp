...
/************** [GLOBAL VARIABLES] **************/
string month; i64 k; map<string, i64> Map; vs MonthList;
/************************************************/
...
void Input() {
	cin >> month >> k;
	Map["January"] = 0; MonthList.pub("January");
	Map["February"] = 1; MonthList.pub("February");
	Map["March"] = 2; MonthList.pub("March");
	Map["April"] = 3; MonthList.pub("April");
	Map["May"] = 4; MonthList.pub("May");
	Map["June"] = 5; MonthList.pub("June");
	Map["July"] = 6; MonthList.pub("July");
	Map["August"] = 7; MonthList.pub("August");
	Map["September"] = 8; MonthList.pub("September");
	Map["October"] = 9; MonthList.pub("October");
	Map["November"] = 10; MonthList.pub("November");
	Map["December"] = 11; MonthList.pub("December");
}

void Solve() {
	cout << MonthList[(Map[month] + k) % 12];
}
/*****************************************/
