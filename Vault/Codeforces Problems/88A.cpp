...
/************** [GLOBAL VARIABLES] **************/
string s1, s2, s3; map<string, int> Note;
/************************************************/
...
void Solve() {
	if (Note[s1] > Note[s2]) swap(s1, s2);
	if (Note[s2] > Note[s3]) swap(s2, s3);
	if (Note[s1] > Note[s2]) swap(s1, s2);
	if ((Note[s2] - Note[s1] + 24) % 12 == 3 && (Note[s3] - Note[s2] + 24) % 12 == 4) cout << "minor";
	else if ((Note[s3] - Note[s1] + 24) % 12 == 3 && (Note[s2] - Note[s3] + 24) % 12 == 4) cout << "minor";
	else if ((Note[s1] - Note[s2] + 24) % 12 == 3 && (Note[s3] - Note[s1] + 24) % 12 == 4) cout << "minor";
	else if ((Note[s3] - Note[s2] + 24) % 12 == 3 && (Note[s1] - Note[s3] + 24) % 12 == 4) cout << "minor";
	else if ((Note[s1] - Note[s3] + 24) % 12 == 3 && (Note[s2] - Note[s1] + 24) % 12 == 4) cout << "minor";
	else if ((Note[s2] - Note[s3] + 24) % 12 == 3 && (Note[s1] - Note[s2] + 24) % 12 == 4) cout << "minor";
	else if ((Note[s2] - Note[s1] + 24) % 12 == 4 && (Note[s3] - Note[s2] + 24) % 12 == 3) cout << "major";
	else if ((Note[s3] - Note[s1] + 24) % 12 == 4 && (Note[s2] - Note[s3] + 24) % 12 == 3) cout << "major";
	else if ((Note[s1] - Note[s2] + 24) % 12 == 4 && (Note[s3] - Note[s1] + 24) % 12 == 3) cout << "major";
	else if ((Note[s3] - Note[s2] + 24) % 12 == 4 && (Note[s1] - Note[s3] + 24) % 12 == 3) cout << "major";
	else if ((Note[s1] - Note[s3] + 24) % 12 == 4 && (Note[s2] - Note[s1] + 24) % 12 == 3) cout << "major";
	else if ((Note[s2] - Note[s3] + 24) % 12 == 4 && (Note[s1] - Note[s2] + 24) % 12 == 3) cout << "major";
	else cout << "strange";
}
/*****************************************/
