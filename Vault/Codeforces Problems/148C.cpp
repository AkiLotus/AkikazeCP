...
void Solve() {
	...
	if (b == 0) {
		if (a + 1 == n) {cout << "-1"; return;}
		cout << "49000 48000"; i64 f = 49000;
		for (i64 i=1; i<=a; i++) cout << " " << f+i;
		for (i64 i=0; i<n-a-2; i++) cout << " 1"; return;
	}
	cout << "1"; i64 f = 1;
	for (i64 i=0; i<b; i++) {f *= 2; cout << " " << f;}
	for (i64 i=0; i<a; i++) {f++; cout << " " << f;}
	for (i64 i=0; i<n-a-b-1; i++) cout << " 1";
}
/*****************************************/
