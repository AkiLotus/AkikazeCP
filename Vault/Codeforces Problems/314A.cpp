...
/***********************************************
** File name: 314A.cpp                        **
** Time created: Tue Dec 25 2018 11:08am      **
***********************************************/
...
void Solve() {
	i64 sum = 0, cnt = 0; vi ElimList;
	for (i64 i=0; i<n; i++) {
		if (sum - cnt * (n - ElimList.size() - cnt - 1) * a[i] < k) ElimList.pub(i+1);
		else {sum += a[i] * cnt; cnt++;}
	}
	for (auto z: ElimList) cout << z << endl;
}
/*****************************************/
