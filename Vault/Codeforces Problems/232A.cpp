...
/***********************************************
** File name: 232A.cpp                        **
** Time created: Mon Feb 18 2019 10:34am      **
***********************************************/
...
void Solve() {
	i64 n = TripletFull_max(k);
	pairwiseFill(0, n-1); k -= n * (n - 1) * (n - 2) / 6;
	while (k > 0) {
		i64 z = DoubletFull_max(k);
