...
/***********************************************
** File name: 181A.cpp                        **
** Time created: Thu Dec 27 2018 11:48am      **
***********************************************/
...
/************** [GLOBAL VARIABLES] **************/
i64 n, m, MinX = LINF, MaxX = -LINF, MinY = LINF, MaxY = -LINF;
char c; vector<vc> A;
/************************************************/
...
void Solve() {
	if (A[MinX-1][MinY-1] == '.') {cout << MinX << " " << MinY << endl; return;}
	if (A[MinX-1][MaxY-1] == '.') {cout << MinX << " " << MaxY << endl; return;}
	if (A[MaxX-1][MinY-1] == '.') {cout << MaxX << " " << MinY << endl; return;}
	if (A[MaxX-1][MaxY-1] == '.') {cout << MaxX << " " << MaxY << endl; return;}
}
/*****************************************/
