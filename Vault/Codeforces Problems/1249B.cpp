...
// File name: 1249B.cpp
// Time created: Thu Nov 21 2019 17:21
...
/************** [GLOBAL VARIABLES] **************/
int n; vector<int> p; vector<bool> vis;
/************************************************/

/************** [FUNCTIONS] **************/
void DFS(int z, vector<int> &List) {
	List.push_back(z); vis[z] = true;
	if (!vis[p[z]]) DFS(p[z], List);
}
...
void Solve() {
	...
	for (int i=0; i<n; i++) {
		...
		vector<int> List;
		DFS(i, List);
		for (auto z: List) res[z] = List.size();
	}
