...
/***********************************************
** File name: 1039B.cpp                       **
** Time created: Sat Jan 5 2019 15:59pm       **
***********************************************/
...
void Solve() {
	string verdict;
	for (i64 turn=0; turn<4500; turn++) {
		//cout << "turn passed = " << turn << endl;
		i64 Len = r - l + 1;
		if (Len <= 8 * k) {
			i64 pos = l + rng64() % Len;
			cout << pos << " " << pos << endl; fflush(stdout);
			cin >> verdict; if (verdict == "Yes") return;
