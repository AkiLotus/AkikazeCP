...
i64 n, a, F = 0, S = 0; vi Fi, Se; i64 last = 0;
/************************************************/
...
void Input() {
	...
	while (n--) {
		cin >> a;
		if (a > 0) {F += a;Fi.pub(a); last = 1;}
		else if (a < 0) {S -= a; Se.pub(-a); last = 2;}
	}
}

void Solve() {
	if (F < S) cout << "second"; else if (F > S) cout << "first";
	else if (Fi > Se) cout << "first"; else if (Se > Fi) cout << "second";
	else if (last == 1) cout << "first"; else cout << "second";
}
/*****************************************/
