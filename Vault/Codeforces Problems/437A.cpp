...
string A, B, C, D; i64 aA, aB, aC, aD;
/************************************************/
...
void Solve() {
	i64 cnt = 0; char last = '\0';
	if ((aA >= aB * 2 && aA >= aC * 2 && aA >= aD * 2) || (aB >= aA * 2 && aC >= aA * 2 && aD >= aA * 2)) {
		cnt++; last = 'A';
	}
	if ((aB >= aA * 2 && aB >= aC * 2 && aB >= aD * 2) || (aA >= aB * 2 && aC >= aB * 2 && aD >= aB * 2)) {
		cnt++; last = 'B';
	}
	if ((aC >= aB * 2 && aC >= aA * 2 && aC >= aD * 2) || (aB >= aC * 2 && aA >= aC * 2 && aD >= aC * 2)) {
		cnt++; last = 'C';
	}
	if ((aD >= aB * 2 && aD >= aC * 2 && aD >= aA * 2) || (aB >= aD * 2 && aC >= aD * 2 && aA >= aD * 2)) {
		cnt++; last = 'D';
	}
	if (cnt != 1) cout << "C"; else cout << last;
}
/*****************************************/
