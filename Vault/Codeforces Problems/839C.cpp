...
/** -----CUSTOM TYPEDEFS----- **/
i64 n; vector<vector<i64>> adj;
vector<bool> visited; vector<ld> dp;
i64 totalLength = 0, leafCount = 0;
...
void VarInput() {
	...
	adj.resize(n+1, vector<i64>(0)); dp.resize(n+1, 0.0);
	for (i64 i=1; i<n; i++) {
		i64 a, b; cin >> a >> b;
