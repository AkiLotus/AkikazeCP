...
/***********************************************
** File name: 490D.cpp                        **
** Time created: Wed Jan 2 2019 14:53pm       **
***********************************************/
...
void Input() {
	cin >> a1 >> b1 >> a2 >> b2;
	area1 = a1 * b1; area2 = a2 * b2;
}

void Solve() {
	i64 x1 = area1, x2 = area2;
	i64 pow2_1 = 0, pow3_1 = 0, pow2_2 = 0, pow3_2 = 0;
	while (x1 % 2 == 0) {pow2_1++; x1 /= 2;}
	while (x2 % 2 == 0) {pow2_2++; x2 /= 2;}
	while (x1 % 3 == 0) {pow3_1++; x1 /= 3;}
	while (x2 % 3 == 0) {pow3_2++; x2 /= 3;}
	if (x1 != x2) {cout << "-1\n"; return;}
	i64 turns = 0;
	while (a1 * b1 != a2 * b2) {
		if (pow3_1 != pow3_2) {
	...
	else cout << turns << endl << a1 << " " << b1 << endl << a2 << " " << b2 << endl;
}
/*****************************************/
