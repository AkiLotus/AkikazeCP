...
i64 calc(i64 z) {
	...
	while (z > 0) {
		if (z % 10 == 0) res += 6;
		else if (z % 10 == 1) res += 2;
		else if (z % 10 == 2) res += 5;
		else if (z % 10 == 3) res += 5;
		else if (z % 10 == 4) res += 4;
		else if (z % 10 == 5) res += 5;
		else if (z % 10 == 6) res += 6;
		else if (z % 10 == 7) res += 3;
		else if (z % 10 == 8) res += 7;
		else if (z % 10 == 9) res += 6;
		z /= 10;
	}
	return res;
}
