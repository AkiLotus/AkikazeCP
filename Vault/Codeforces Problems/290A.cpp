...
void Solve() {
	if (a == 01) cout << "Washington";
	if (a == 02) cout << "Adams";
	if (a == 03) cout << "Jefferson";
	if (a == 04) cout << "Madison";
	if (a == 05) cout << "Monroe";
	if (a == 06) cout << "Adams";
	if (a == 07) cout << "Jackson";
	if (a == 8) cout << "Van Buren";
	if (a == 9) cout << "Harrison";
	if (a == 10) cout << "Tyler";
	if (a == 11) cout << "Polk";
	if (a == 12) cout << "Taylor";
	if (a == 13) cout << "Fillmore";
	if (a == 14) cout << "Pierce";
	if (a == 15) cout << "Buchanan";
	if (a == 16) cout << "Lincoln";
	if (a == 17) cout << "Johnson";
	if (a == 18) cout << "Grant";
	if (a == 19) cout << "Hayes";
	if (a == 20) cout << "Garfield";
	if (a == 21) cout << "Arthur";
	if (a == 22) cout << "Cleveland";
	if (a == 23) cout << "Harrison";
	if (a == 24) cout << "Cleveland";
	if (a == 25) cout << "McKinley";
	if (a == 26) cout << "Roosevelt";
	if (a == 27) cout << "Taft";
	if (a == 28) cout << "Wilson";
	if (a == 29) cout << "Harding";
	if (a == 30) cout << "Coolidge";
	if (a == 31) cout << "Hoover";
	if (a == 32) cout << "Roosevelt";
	if (a == 33) cout << "Truman";
	if (a == 34) cout << "Eisenhower";
	if (a == 35) cout << "Kennedy";
	if (a == 36) cout << "Johnson";
	if (a == 37) cout << "Nixon";
	if (a == 38) cout << "Ford";
	if (a == 39) cout << "Carter";
	if (a == 40) cout << "Reagan";
