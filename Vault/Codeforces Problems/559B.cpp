...
bool equivalent(string x, string y) {
	...
	i64 n = x.size();
	return ((equivalent(x.substr(0, n/2), y.substr(0, n/2)) && equivalent(x.substr(n/2, n/2), y.substr(n/2, n/2))) ||
			(equivalent(x.substr(n/2, n/2), y.substr(0, n/2)) && equivalent(x.substr(0, n/2), y.substr(n/2, n/2))));
}
