...
// File name: CFR555D3B.cpp
// Time created: Sun May 19 2019 07:15
...
void Solve() {
	...
	if (ptr1 != -1) {
		for (int x=ptr1; x<=ptr2; x++) s[x] = char(48 + f[s[x] - '0']);
	}
	cout << s << endl;
}
/*****************************************/
