...
i64 n; unordered_map<i64, i64> Map;
/************************************************/
...
void Try(i64 s, i64 c1, i64 c5, i64 c10, i64 c50) {
	if (c50 && !Map[s-49]) {Map[s-49]++; Try(s-49, c1+1, c5, c10, c50-1);}
	if (c50 && !Map[s-45]) {Map[s-45]++; Try(s-45, c1, c5+1, c10, c50-1);}
	if (c50 && !Map[s-40]) {Map[s-40]++; Try(s-40, c1, c5, c10+1, c50-1);}
	if (c10 && !Map[s-9]) {Map[s-9]++; Try(s-9, c1+1, c5, c10-1, c50);}
	if (c10 && !Map[s-5]) {Map[s-5]++; Try(s-5, c1, c5+1, c10-1, c50);}
	if (c5 && !Map[s-4]) {Map[s-4]++; Try(s-4, c1+1, c5-1, c10, c50);}
}
