...
/***********************************************
** File name: CFR527D3F.cpp                   **
** Time created: Tue Dec 18 2018 15:07pm      **
***********************************************/
...
/************** [GLOBAL VARIABLES] **************/
i64 n, u, v; vi a, d, subtree, dp; vector<vi> adj;
/************************************************/
...
void Input() {
	cin >> n; adj.rsz(n); a.rsz(n);
	subtree.rsz(n); dp.rsz(n); d.rsz(n);
	for (auto &x: a) cin >> x;
	for (i64 i=1; i<n; i++) {
		cin >> u >> v; u--; v--;
