...
bool valid(string str) {
	i64 d = (str[0] - 48) * 10 + (str[1] - 48);
	i64 m = (str[2] - 48) * 10 + (str[3] - 48);
	i64 y = (str[4] - 48) * 1000 + (str[5] - 48) * 100 + (str[6] - 48) * 10 + (str[7] - 48) * 1;
	if (y < 1) return false;
...
bool earlier(string str) {
	i64 d1 = (str[0] - 48) * 10 + (str[1] - 48);
	i64 m1 = (str[2] - 48) * 10 + (str[3] - 48);
	i64 y1 = (str[4] - 48) * 1000 + (str[5] - 48) * 100 + (str[6] - 48) * 10 + (str[7] - 48) * 1;
	i64 d2 = (ans[0] - 48) * 10 + (ans[1] - 48);
	i64 m2 = (ans[2] - 48) * 10 + (ans[3] - 48);
	i64 y2 = (ans[4] - 48) * 1000 + (ans[5] - 48) * 100 + (ans[6] - 48) * 10 + (ans[7] - 48) * 1;
