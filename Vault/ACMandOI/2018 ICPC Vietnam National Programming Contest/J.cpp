...
// File name: J.cpp
// Time created: Fri Jun 07 2019 12:49
...
void Solve() {
	bool possible_chikapu = false;
	bool odd = (n % 2 != 0);
	bool sten_syngergy = (s[0] == s[n-1]);
	for (int i=2; i<n; i++) {
		if (s[i] != s[i-2]) {
			possible_chikapu = true;
		}
	}
	if (possible_chikapu && ((odd && !sten_syngergy) || (!odd && sten_syngergy))) cout << "Chikapu\n";
	else cout << "Bash\n";
}
/*****************************************/
