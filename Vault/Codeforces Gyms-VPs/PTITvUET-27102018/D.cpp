...
void TimerStop();
void Exit();
string cppstr_infile = "digital.in";
string cppstr_outfile = "digital.out";
/*********************************************************/

/************** [GLOBAL VARIABLES] **************/
typedef pair<ppi, i64> pppi;
i64 w; vector<vi> a; vector<vector<vb>> dp;
vector<vector<vector<pppi>>> Last; vector<vi> Zero;
/************************************************/

/************** [FUNCTIONS] **************/
bool fit(i64 i, i64 j, i64 k, i64 mask) {
    vector<vi> A(9), B(9);
    for (i64 it=0; it<9; it++) {
        i64 n = it % 2 + 1; A[it].rsz(n, 0); B[it].rsz(n, 0);
        for (i64 ite=0; ite<n; ite++) A[it][ite] = a[it][ite+i];
    }
    for (i64 it=0; it<4; it++) {
        if ((j & (1LL << it)) == 0) continue;
        B[it*2+1][1] = 1;
    }
    
    i64 x = mask / 100, y = (mask - x * 100) / 10, z = (mask - x * 100 - y * 10);
    
    if ((x + y + k) % 10 != z) return false;
    if (i == 0 && (x + y + k) != z) return false;
    
    if (x == 0) {B[0][0] = 1; B[1][0] = 1; B[1][1] = 1; B[3][0] = 1; B[3][1] = 1; B[4][0] = 1;}
    else if (x == 1) {B[1][1] = 1; B[3][1] = 1;}
    else if (x == 2) {B[0][0] = 1; B[1][1] = 1; B[2][0] = 1; B[3][0] = 1; B[4][0] = 1;}
    else if (x == 3) {B[0][0] = 1; B[1][1] = 1; B[2][0] = 1; B[3][1] = 1; B[4][0] = 1;}
    else if (x == 4) {B[1][0] = 1; B[1][1] = 1; B[2][0] = 1; B[3][1] = 1;}
    else if (x == 5) {B[0][0] = 1; B[1][0] = 1; B[2][0] = 1; B[3][1] = 1; B[4][0] = 1;}
    else if (x == 6) {B[0][0] = 1; B[1][0] = 1; B[2][0] = 1; B[3][0] = 1; B[3][1] = 1; B[4][0] = 1;}
    else if (x == 7) {B[0][0] = 1; B[1][1] = 1; B[3][1] = 1;}
    else if (x == 8) {B[0][0] = 1; B[1][0] = 1; B[1][1] = 1; B[2][0] = 1; B[2][1] = 1; B[3][0] = 1; B[3][1] = 1; B[4][0] = 1;}
    else if (x == 9) {B[0][0] = 1; B[1][0] = 1; B[1][1] = 1; B[2][0] = 1; B[2][1] = 1; B[3][1] = 1; B[4][0] = 1;}
    
    if (y == 0) {B[2][0] = 1; B[3][0] = 1; B[3][1] = 1; B[5][0] = 1; B[5][1] = 1; B[6][0] = 1;}
    else if (y == 1) {B[3][1] = 1; B[5][1] = 1;}
    else if (y == 2) {B[2][0] = 1; B[3][1] = 1; B[4][0] = 1; B[5][0] = 1; B[6][0] = 1;}
    else if (y == 3) {B[2][0] = 1; B[3][1] = 1; B[4][0] = 1; B[5][1] = 1; B[6][0] = 1;}
    else if (y == 4) {B[3][0] = 1; B[3][1] = 1; B[4][0] = 1; B[5][1] = 1;}
    else if (y == 5) {B[2][0] = 1; B[3][0] = 1; B[4][0] = 1; B[5][1] = 1; B[6][0] = 1;}
    else if (y == 6) {B[2][0] = 1; B[3][0] = 1; B[4][0] = 1; B[5][0] = 1; B[5][1] = 1; B[6][0] = 1;}
    else if (y == 7) {B[2][0] = 1; B[3][1] = 1; B[5][1] = 1;}
    else if (y == 8) {B[2][0] = 1; B[3][0] = 1; B[3][1] = 1; B[4][0] = 1; B[4][1] = 1; B[5][0] = 1; B[5][1] = 1; B[6][0] = 1;}
    else if (y == 9) {B[2][0] = 1; B[3][0] = 1; B[3][1] = 1; B[4][0] = 1; B[4][1] = 1; B[5][1] = 1; B[6][0] = 1;}
    
    if (z == 0) {B[4][0] = 1; B[5][0] = 1; B[5][1] = 1; B[7][0] = 1; B[7][1] = 1; B[8][0] = 1;}
    else if (z == 1) {B[5][1] = 1; B[7][1] = 1;}
    else if (z == 2) {B[4][0] = 1; B[5][1] = 1; B[6][0] = 1; B[7][0] = 1; B[8][0] = 1;}
    else if (z == 3) {B[4][0] = 1; B[5][1] = 1; B[6][0] = 1; B[7][1] = 1; B[8][0] = 1;}
    else if (z == 4) {B[5][0] = 1; B[5][1] = 1; B[6][0] = 1; B[7][1] = 1;}
    else if (z == 5) {B[4][0] = 1; B[5][0] = 1; B[6][0] = 1; B[7][1] = 1; B[8][0] = 1;}
    else if (z == 6) {B[4][0] = 1; B[5][0] = 1; B[6][0] = 1; B[7][0] = 1; B[7][1] = 1; B[8][0] = 1;}
    else if (z == 7) {B[4][0] = 1; B[5][1] = 1; B[7][1] = 1;}
    else if (z == 8) {B[4][0] = 1; B[5][0] = 1; B[5][1] = 1; B[6][0] = 1; B[6][1] = 1; B[7][0] = 1; B[7][1] = 1; B[8][0] = 1;}
    else if (z == 9) {B[4][0] = 1; B[5][0] = 1; B[5][1] = 1; B[6][0] = 1; B[6][1] = 1; B[7][1] = 1; B[8][0] = 1;}
    
	for (i64 x=0; x<9; x++) {
		for (i64 y=0; y<A[x].size(); y++) {
			if (x % 2 == 1 && y == 0 && i > 0) continue;
...
i64 fillleft(i64 j) {
    i64 x = j / 100, y = (j - x * 100) / 10, z = (j - x * 100 - y * 10); i64 res = 0;
    if (x == 1 || x == 3 || x == 7) res |= 0; if (x == 4 || x == 5 || x == 9) res |= 1;
    if (x == 2) res |= 2; if (x == 0 || x == 6 || x == 8) res |= 3;
    if (y == 1 || y == 3 || y == 7) res |= 0; if (y == 4 || y == 5 || y == 9) res |= 2;
    if (y == 2) res |= 4; if (y == 0 || y == 6 || y == 8) res |= 6;
    if (z == 1 || z == 3 || z == 7) res |= 0; if (z == 4 || z == 5 || z == 9) res |= 4;
    if (z == 2) res |= 8; if (z == 0 || z == 6 || z == 8) res |= 12;
    return res;
}

void Input() {
	scanf("%I64d", &w); a.rsz(9); dp.rsz(w+1, vector<vb>(16, vb(2, false)));
    Last.rsz(w+1, vector<vector<pppi>>(16, vector<pppi>(2, mp(mp(mp(-1LL, -1LL), -1LL), -1LL))));
    dp[w][0][0] = true; Zero.rsz(3, vi(w, -1));
    for (i64 i=0; i<a.size(); i++) {
        i64 n = w + i % 2; a[i].rsz(n, 4);
        for (i64 j=0; j<n; j++) scanf("%I64d", &a[i][j]);
    }
}
...
void Solve() {
	for (i64 i=w; i>0; i--) {
        for (i64 j=0; j<16; j++) {
            for (i64 k=0; k<2; k++) {
                ...
                for (i64 mask=0; mask<1000; mask++) {
					i64 x = mask / 100, y = (mask - x * 100) / 10, z = (mask - x * 100 - y * 10);
					if (fit(i-1, j, k, mask)) {
						Last[i-1][fillleft(mask)][(x+y+k-z)/10] = mp(mp(mp(i, j), k), mask);
						dp[i-1][fillleft(mask)][(x+y+k-z)/10] = true;
					}
                }
            }
        }
    ...
    for (i64 j=0; j<16; j++) {
        for (i64 k=0; k<2; k++) {
            ...
            i64 r = 0;
            while (Last[r][j][k] != mp(mp(mp(-1LL, -1LL), -1LL), -1LL)) {
                pppi QAQ = Last[r][j][k];
                i64 r1 = QAQ.fi.fi.fi, j1 = QAQ.fi.fi.se, k1 = QAQ.fi.se, mask = QAQ.se;
                i64 x = mask / 100, y = (mask - x * 100) / 10, z = (mask - x * 100 - y * 10);
                Zero[0][r] = x; Zero[1][r] = y; Zero[2][r] = z;
                r = r1; j = j1; k = k1;
            }
            for (i64 AB=0; AB<3; AB++) {
                for (i64 CD=0; CD<w; CD++) {
                    printf("%I64d", Zero[AB][CD]);
                }
                printf("\n");
            }
            return;
