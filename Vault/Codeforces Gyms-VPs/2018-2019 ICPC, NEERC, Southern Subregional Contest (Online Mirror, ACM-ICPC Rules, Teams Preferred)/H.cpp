...
/************** [GLOBAL VARIABLES] **************/
i64 n, q; vs a; string s;
map<string, i64> Map; map<string, string> Match;
/************************************************/
...
void Solve() {
	...
	while (q--) {
		cin >> s;
		if (Map.find(s) == Map.end()) cout << "0 -\n";
		else cout << Map[s] << " " << Match[s] << endl;
	}
}
/*****************************************/
