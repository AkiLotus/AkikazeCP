...
void Solve() {
	for (i64 i=0; i<8; i++) {
		for (i64 j=0; j<8; j++) {
			...
			if (a[i][j] <= 'Z') continue;
			if (a[i][j] == 'p') {
				i64 x1 = i-1, x2 = i-1, y1 = j-1, y2 = j+1;
				if (x1 == x && y1 == y) {cout << "Sim"; return;}
				if (x2 == x && y2 == y) {cout << "Sim"; return;}
			}
			if (a[i][j] == 'c') {
				i64 x1 = i-2, y1 = j-1;
				i64 x2 = i-2, y2 = j+1;
				...
				if (x1 == x && y1 == y) {cout << "Sim"; return;}
				if (x2 == x && y2 == y) {cout << "Sim"; return;}
				if (x3 == x && y3 == y) {cout << "Sim"; return;}
				if (x4 == x && y4 == y) {cout << "Sim"; return;}
				if (x5 == x && y5 == y) {cout << "Sim"; return;}
				if (x6 == x && y6 == y) {cout << "Sim"; return;}
				if (x7 == x && y7 == y) {cout << "Sim"; return;}
				if (x8 == x && y8 == y) {cout << "Sim"; return;}
			}
			if (a[i][j] == 'k') {
				i64 x1 = i-1, y1 = j-1;
				i64 x2 = i-1, y2 = j+0;
			...
			if (a[i][j] == 't' || a[i][j] == 'r') {
				...
				i64 x3 = i, y3 = j-1;
				i64 x4 = i, y4 = j+1;
				while (x1 >= 0 && a[x1][y1] == '.') x1--;
				while (x2 < 8 && a[x2][y2] == '.') x2++;
				while (y3 >= 0 && a[x3][y3] == '.') y3--;
				while (y4 < 8 && a[x4][y4] == '.') y4++;
				if (x1 == x && y1 == y) {cout << "Sim"; return;}
				if (x2 == x && y2 == y) {cout << "Sim"; return;}
				if (x3 == x && y3 == y) {cout << "Sim"; return;}
				if (x4 == x && y4 == y) {cout << "Sim"; return;}
			...
			if (a[i][j] == 'b' || a[i][j] == 'r') {
				...
				i64 x3 = i+1, y3 = j-1;
				i64 x4 = i-1, y4 = j+1;
				while (x1 >= 0 && y1 >= 0 && a[x1][y1] == '.') {x1--; y1--;}
				while (x2 < 8 && y2 < 8 && a[x2][y2] == '.') {x2++; y2++;}
				while (y3 >= 0 && x3 < 8 && a[x3][y3] == '.') {y3--; x3++;}
				while (y4 < 8 && x4 >= 0 && a[x4][y4] == '.') {y4++; x4--;}
				if (x1 == x && y1 == y) {cout << "Sim"; return;}
				if (x2 == x && y2 == y) {cout << "Sim"; return;}
				if (x3 == x && y3 == y) {cout << "Sim"; return;}
				if (x4 == x && y4 == y) {cout << "Sim"; return;}
