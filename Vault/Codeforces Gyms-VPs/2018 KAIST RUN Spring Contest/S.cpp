...
/** -----GLOBAL VARIABLES----- **/
i64 r1, r2, r3, r4, f1, f2, f3, f4, N;
map<string, i64> freq, last;
...
void ProSolve() {
	for (i64 t=1; t<=N; t++) {
		i64 type; string user; cin >> type >> user;
		if (type == 1) {freq[user]++; last[user] = t;}
		else {
			if (freq.find(user) == freq.end()) cout << "None\n";
			else if (freq[user] <= f1) {
				if (t - last[user] <= r1) cout << "New Customer\n";
				else if (t - last[user] <= r2) cout << "Promising\n";
				else if (t - last[user] <= r3) cout << "About to Sleep\n";
				else if (t - last[user] <= r4) cout << "Lost\n";
				else cout << "Lost\n";
			}
			else if (freq[user] <= f2) {
				if (t - last[user] <= r1) cout << "Potential Loyalist\n";
				else if (t - last[user] <= r2) cout << "Potential Loyalist\n";
				else if (t - last[user] <= r3) cout << "About to Sleep\n";
				else if (t - last[user] <= r4) cout << "Hibernating\n";
				else cout << "Lost\n";
			}
			else if (freq[user] <= f3) {
				if (t - last[user] <= r1) cout << "Potential Loyalist\n";
				else if (t - last[user] <= r2) cout << "Potential Loyalist\n";
				else if (t - last[user] <= r3) cout << "Need Attention\n";
				else if (t - last[user] <= r4) cout << "About to Leave\n";
				else cout << "About to Leave\n";
			}
			else if (freq[user] <= f4) {
				if (t - last[user] <= r1) cout << "Loyal Customer\n";
				else if (t - last[user] <= r2) cout << "Loyal Customer\n";
				else if (t - last[user] <= r3) cout << "Loyal Customer\n";
				else if (t - last[user] <= r4) cout << "About to Leave\n";
				else cout << "About to Leave\n";
			}
			else {
				if (t - last[user] <= r1) cout << "Champion\n";
				else if (t - last[user] <= r2) cout << "Loyal Customer\n";
				else if (t - last[user] <= r3) cout << "Loyal Customer\n";
				else if (t - last[user] <= r4) cout << "About to Leave\n";
