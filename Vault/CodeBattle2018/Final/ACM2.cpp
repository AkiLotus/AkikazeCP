...
void ProSolve() {
	if (s == "RGB") {cout << "0"; return;}
	if (s == "RBG") {cout << "0"; return;}
	if (s == "GRB") {cout << "0"; return;}
	if (s == "GBR") {cout << "0"; return;}
	if (s == "BRG") {cout << "0"; return;}
	if (s == "BGR") {cout << "0"; return;}
	if (s[0] == 'R' && s[1] == 'G' && s[2] == 'B') {cout << "1"; return;}
	if (s[0] == 'R' && s[1] == 'B' && s[2] == 'G') {cout << "1"; return;}
	if (s[0] == 'G' && s[1] == 'R' && s[2] == 'B') {cout << "1"; return;}
	if (s[0] == 'G' && s[1] == 'B' && s[2] == 'R') {cout << "1"; return;}
	if (s[0] == 'B' && s[1] == 'R' && s[2] == 'G') {cout << "1"; return;}
	if (s[0] == 'B' && s[1] == 'G' && s[2] == 'R') {cout << "1"; return;}
	if (s[s.size()-3] == 'R' && s[s.size()-2] == 'G' && s[s.size()-1] == 'B') {cout << "1"; return;}
	if (s[s.size()-3] == 'R' && s[s.size()-2] == 'B' && s[s.size()-1] == 'G') {cout << "1"; return;}
	if (s[s.size()-3] == 'G' && s[s.size()-2] == 'R' && s[s.size()-1] == 'B') {cout << "1"; return;}
	if (s[s.size()-3] == 'G' && s[s.size()-2] == 'B' && s[s.size()-1] == 'R') {cout << "1"; return;}
	if (s[s.size()-3] == 'B' && s[s.size()-2] == 'R' && s[s.size()-1] == 'G') {cout << "1"; return;}
	if (s[s.size()-3] == 'B' && s[s.size()-2] == 'G' && s[s.size()-1] == 'R') {cout << "1"; return;}
	if (s.find("RGB") < s.size() && s.find("RGB") >= 0) {cout << "2"; return;}
	if (s.find("RBG") < s.size() && s.find("RBG") >= 0) {cout << "2"; return;}
	if (s.find("GRB") < s.size() && s.find("GRB") >= 0) {cout << "2"; return;}
	if (s.find("GBR") < s.size() && s.find("GBR") >= 0) {cout << "2"; return;}
	if (s.find("BRG") < s.size() && s.find("BRG") >= 0) {cout << "2"; return;}
	if (s.find("BGR") < s.size() && s.find("BGR") >= 0) {cout << "2"; return;}
	if (s.find("RG") < s.size() && s.find("RG") > 0 && (s[0] == 'B' || s[s.size()-1] == 'B')) {cout << "3"; return;}
	if (s.find("GR") < s.size() && s.find("GR") > 0 && (s[0] == 'B' || s[s.size()-1] == 'B')) {cout << "3"; return;}
	if (s.find("RB") < s.size() && s.find("RB") > 0 && (s[0] == 'G' || s[s.size()-1] == 'G')) {cout << "3"; return;}
	if (s.find("BR") < s.size() && s.find("BR") > 0 && (s[0] == 'G' || s[s.size()-1] == 'G')) {cout << "3"; return;}
	if (s.find("GB") < s.size() && s.find("GB") > 0 && (s[0] == 'R' || s[s.size()-1] == 'R')) {cout << "3"; return;}
	if (s.find("BG") < s.size() && s.find("BG") > 0 && (s[0] == 'R' || s[s.size()-1] == 'R')) {cout << "3"; return;}
	cout << "4";
}
