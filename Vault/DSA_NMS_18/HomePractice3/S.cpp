...
/** -----GLOBAL VARIABLES----- **/
vi Stack(6666666); i64 ptr1 = 3333333, ptr2 = 3333332;
string cmd; i64 Q;
...
void VarInput() {
	...
	while (Q--) {
		cin >> cmd;
		if (cmd == "PRINTFRONT") {
			if (ptr2 < ptr1) cout << "NONE\n"; else cout << Stack[ptr1] << endl;
		}
		else if (cmd == "PRINTBACK") {
			if (ptr2 < ptr1) cout << "NONE\n"; else cout << Stack[ptr2] << endl;
		}
			...
			i64 x; cin >> x; Stack[--ptr1] = x;
		}
		else if (cmd == "PUSHBACK") {
			i64 x; cin >> x; Stack[++ptr2] = x;
		}
	}
}
