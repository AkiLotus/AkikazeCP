...
rem Purpose: run pc2 Netcat program
...
java -Djdk.crypto.KeyAgreement.legacyKDF=true -Xms64M -Xmx768M -cp %libdir%\pc2.jar edu.csus.ecs.pc2.tools.Netcat %1 %2 %3 %4 %5 %6 %7
